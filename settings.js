...
module.exports = {
    ...
    // add your Session Id make sure it starts with pheazy~

    PREFIX: process.env.PREFIX || ".",
    // add your prefix for bot

    BOT_NAME: process.env.BOT_NAME || "Pheazy-MD",
    ...
    AUTO_STATUS_MSG: process.env.AUTO_STATUS_MSG || "*SEEN YOUR STATUS BY ♀️ LORD-PHEAZY 😆*",
...
ᴋᴇᴇᴘ ᴜsɪɴɢ ✦Pheazy-MD✦ ғʀᴏᴍ ♀️ LORD-PHEAZY ɪɴᴄ⚡
...
> ɢɪᴛʜᴜʙ : github.com/Tallisman5/Pheazy-MD`,
    ...
    OWNER_NAME: process.env.OWNER_NAME || "Pheazy-MD",
    // add bot owner name

    DESCRIPTION: process.env.DESCRIPTION || "*© ᴘᴏᴡᴇʀᴇᴅ ʙʏ ♀️ Lord-Pheazy*",
...
`*Hᴇʟʟᴏ ᴛʜᴇʀᴇ Pheazy-MD ᴄᴏɴɴᴇᴄᴛᴇᴅ! 👋🏻* 

*ᴋᴇᴇᴘ ᴏɴ ᴜsɪɴɢ Pheazy ᴍᴏᴅs🚩* 
